...
namespace forbcc {
    ...
    protected:
        ...
        /// Constructor used only by some subclasses for global data
        entity(nullptr_t) : _parent(nullptr), _name("") {};
    ...
    public:
        ...
        virtual std::string codename() const {
            std::string parentname = (_parent != nullptr) ? _parent->codename() : "";

            return (parentname.length()) ? parentname + "::" + _name : _name;
        };
    };
}
